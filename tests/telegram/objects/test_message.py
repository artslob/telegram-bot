...
def test_message(parse_message_dict):
    ...
    assert message.chat.id == 1111111
    assert message.chat.type == 'private'
    assert message.chat.username == 'Testusername'
    assert message.chat.first_name == 'Test Firstname'
    assert message.chat.last_name == 'Test Lastname'
